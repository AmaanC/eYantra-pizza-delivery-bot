...
void main() {
    ...
    while (1) {
        ...
        ServoControl(2, CLOSE_GRIPPER_1); // Close grip
        _delay_ms(3000);
        ServoControl(3, CLOSE_GRIPPER_2); // Close grip
        _delay_ms(3000);
